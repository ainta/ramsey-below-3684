...
compressed long paths into **41,794,061 runs**, and checked bounded chunks in
Lean. Large run batches use four 1,024-check declarations joined by a proved
...
- [pinned_final_theorem.log](../runs/pinned_final_theorem.log): final axiom inventory.
